// scripts/PsBridge/Reflection.Invocation.cs
using System;
...
{
    private static Dictionary<string, object> HandleInvoke(Dictionary<string, object> cmd)
    {
    ...
    private static Dictionary<string, object> HandleAwaitTask(Dictionary<string, object> cmd)
    {
    ...
    private static Dictionary<string, object> HandleInvokeDetached(Dictionary<string, object> cmd)
    {
